...
class VAE(tf.keras.Model):
    def __init__(self, name,
        ...
        self.encoder_network = vae_layers.VAE_encoder('encoder_etwork', self.n_dim, self.n_width)
        self.decoder_network=vae_layers.VAE_decoder('decoder_network',self.data_dim, self.n_width)
    ...
    def call(self, inputs):
        ...
        ELBO=-KL_divergence+log_pdf

        vae_cost=-ELBO
        return vae_cost, KL_divergence, log_pdf
